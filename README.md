...
* 1\. [ARTIFICIAL INTELLIGENCE](#1-ARTIFICIAL-INTELLIGENCE)
    ...
    * 1.2\. [Advantages of AI](#1.2-Advantages-of-AI)
    * 1.3\. [Ability to learn](#1.3-Ability-to-learn)
    * 1.4\. [Ability of collaboration](#1.4-Ability-of-collaboration)
       
* 2\.  [SDN/NFV](#2-SDN/NFV)
    * 2.1\. [SDN](#2.1-SDN) 
    * 2.2\. [SDN Architecture](#2.2-SDN-Architecture) 
    * 2.3\. [NFV](#2.3-NFV) 
    * 2.4\. [NFV Architecture](#2.4-NFV-Architecture) 
    * 2.5\. [NFV relationship to SDN](#2.5-NFV-relationship-to-SDN) 
* 3\. [ POSSIBILITY TO USE AI IN NETWORKING AND COMMUNICATION](#3-POSSIBILITY-TO-USE-AI-IN-NETWORKING-AND-COMMUNICATION)
    * 3.1\. [AI in SDN](#3.1-AI-in-SDN) 
      * 3.1.1\. [Neural Networks in SDN](#3.1.1-Neural-Networks-in-SDN) 
      * 3.1.2\. [CIPA](#3.1.2-CIPA) 
      * 3.1.3\. [Neural Network for Load Balancing](#3.1.3Neural-Network-for-Load-Balancing) 
    * 3.2\. [AI in NFV](#3.2-AI-in-NFV) 
      * 3.2.1\. [IP traffic classification in NFV](#3.2.1-IP-traffic-classification-in-NFV) 
